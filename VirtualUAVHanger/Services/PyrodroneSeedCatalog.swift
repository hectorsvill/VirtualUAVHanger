...
enum PyrodroneSeedCatalog {
    ...
    static let entries: [PyrodroneSeedEntry] = rtfDrones + motors + escs + flightControllers + vtxUnits

    // MARK: - RTF / BNF / PNP Drones

    static let rtfDrones: [PyrodroneSeedEntry] = [
        .init(
            kind: .drone,
        ...
        .init(
            kind: .drone,
            name: "EMAX Tinyhawk II Racing Drone RTF",
            brand: "EMAX",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "Emax Tinyhawk II Freestyle RTF Kit With Controller & Goggles",
            brand: "EMAX",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "EMAX EZ Pilot 75mm Beginner Indoor Racing Drone - RTF",
            brand: "EMAX",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "HappyModel BNF Mobula 6 1S Micro Whoop Quadcopter",
            brand: "HappyModel",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "Happymodel Mobula8 1-2S 85mm Analog Micro FPV Whoop Drone",
            brand: "HappyModel",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "Happymodel Mobula7 1S 75mm Analog FPV Brushless Whoop",
            brand: "HappyModel",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "BetaFPV Air65 1S 65mm Analog 400mW ELRS 2.4G Brushless Whoop",
            brand: "BetaFPV",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "BetaFPV Air75 1S 75mm Analog 400mW VTX Brushless Whoop",
            brand: "BetaFPV",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "BetaFPV Pavo20 Pro 2.2\" Cinewhoop Quadcopter (DJI O3)",
            brand: "BetaFPV",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "BetaFPV Meteor75 Pro 1S 75mm HD with O4 Air Unit",
            brand: "BetaFPV",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "DarwinFPV Darwin129 7\" Long Range PNP",
            brand: "DarwinFPV",
            category: nil,
            quantity: nil,
        ...
        .init(
            kind: .drone,
            name: "NewBeeDrone Hummingbird V3.1 RaceSpec 1S Analog ELRS BNF",
            brand: "NewBeeDrone",
            category: nil,
            quantity: nil,
    ...
    static let motors: [PyrodroneSeedEntry] = [
        .init(
            kind: .part,
        ...
        .init(
            kind: .part,
            name: "HYPERLITE 2408.5 Team Edition 1322KV Motor",
            brand: "Brother Hobby",
            category: .motor,
            quantity: 4,
        ...
        .init(
            kind: .part,
            name: "iFlight XING-E Pro 2207 1800KV 2-6S FPV Motor",
            brand: "iFlight",
            category: .motor,
            quantity: 4,
        ...
        .init(
            kind: .part,
            name: "Emax ECO II 2207 1900KV Stator Motor",
            brand: "EMAX",
            category: .motor,
            quantity: 4,
        ...
        .init(
            kind: .part,
            name: "Emax ECO II 2306 1700KV Stator Motor",
            brand: "EMAX",
            category: .motor,
            quantity: 4,
        ...
        .init(
            kind: .part,
            name: "BrotherHobby Avenger 2806.5 1300KV Motor",
            brand: "Brother Hobby",
            category: .motor,
            quantity: 4,
        ...
        .init(
            kind: .part,
            name: "iFlight XING X2208 1800KV 2-6S FPV NextGen Motor",
            brand: "iFlight",
            category: .motor,
            quantity: 4,
    ...
    static let escs: [PyrodroneSeedEntry] = [
        .init(
            kind: .part,
        ...
        .init(
            kind: .part,
            name: "Foxeer Reaper F4 AM32 65A 3-8S 4in1 ESC - 30x30mm",
            brand: "Foxeer",
            category: .esc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "Foxeer Mini Reaper F4 AM32 45A 3-6S 4in1 ESC - 20x20mm",
            brand: "Foxeer",
            category: .esc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "Lumenier ELITE PRO 60A 2-6S AM32 4-in-1 ESC - 30x30mm",
            brand: "Lumenier",
            category: .esc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "iFlight Borg 60R 3-8S 60A ESC - 20x20mm",
            brand: "iFlight",
            category: .esc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "T-Motor F35A 32Bit 35A 3-6S AM32 Electronic Speed Controller",
            brand: "T-Motor",
            category: .esc,
            quantity: 1,
    ...
    static let flightControllers: [PyrodroneSeedEntry] = [
        .init(
            kind: .part,
            name: "TBS Lucid H7 FC 2-8S Dual Camera Input - 30x30mm",
            brand: "TBS",
            category: .fc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "HDZero Gamma 45A 3-6S HD-Ready AIO Flight Controller",
            brand: "Divimath",
            category: .fc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "BetaFPV Air Brushless Flight Controller G4 4-in-1 AIO 400mW VTX",
            brand: "BetaFPV",
            category: .fc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "Happymodel X14 ELRS 5-IN-1 AIO Flight Controller",
            brand: "HappyModel",
            category: .fc,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "HDZero Halo Stack H7 FC and 70A 3S-8S 4in1 ESC - 20x20mm",
            brand: "Divimath",
            category: .fc,
            quantity: 1,
    ...
    static let vtxUnits: [PyrodroneSeedEntry] = [
        .init(
            kind: .part,
        ...
        .init(
            kind: .part,
            name: "RUSHFPV Tank Tiny 5.8GHz VTX Smart Audio",
            brand: "RushFPV",
            category: .vtx,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "SpeedyBee TX800 5.8GHz Video Transmitter",
            brand: "SpeedyBee",
            category: .vtx,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "iFlight Blitz 5.8GHz 1.6W Adjustable VTX",
            brand: "iFlight",
            category: .vtx,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "Foxeer Reaper Extreme 2.5W V3 5.8GHz Analog VTX",
            brand: "Foxeer",
            category: .vtx,
            quantity: 1,
        ...
        .init(
            kind: .part,
            name: "GEPRC RAD Mini 1W 5.8GHz VTX",
            brand: "GEPRC",
            category: .vtx,
            quantity: 1,
